...
RUN curl -L https://github.com/getAlby/eclair-rabbitmq/archive/refs/tags/v${PLUGIN_VERSION}.zip --output eclair-plugins-${PLUGIN_VERSION}.zip
...
RUN mkdir /plugins
COPY --from=BUILD /root/.m2/repository/com/getalby/eclair/rabbitmqplugin/0.8.0/rabbitmqplugin-0.8.0.jar /plugins/rabbitmqplugin-0.8.0.jar
